...
function add_modo($name, $email, $role, $token)
{
    ...
    $message = '
        <html lang="en" style="font-family: sans-serif;">
            ...
            <body>
                Voici votre identifiant et code unique à insérer sur <a href="http://localhost/blog/admin/index.php?page=new">cette page</a>:
    ...
    $header .= 'From: no-reply@haithem.com' . "\r\n" . 'Reply-To: haithemmihoubi1234@gmail.Com.com' . "\r\n" . 'X-Mailer: PHP/' . phpversion();
