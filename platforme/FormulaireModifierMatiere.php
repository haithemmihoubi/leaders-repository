...
require_once 'connexion.php';
$ref=$_GET['edite'];
$sql="SELECT * FROM matiere WHERE id_matiere='$ref'";
if($ref)
{
...
<div class="card o-hidden border-0 shadow-lg my-5">
    <div class="card-body p-0">
        ...
        <div style="display: flex;">
            <div class="col-lg-5 d-none d-lg-block" style="height:600px;  background-repeat:no-repeat; background-image:url('images/imageMatiere/Matiere.jpg')">
            </div>
                ...
                <div class="p-5">
                    ...
                    <form class="user" action="#" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user"  name="id_matiere" id="id_matiere"  value="<?php echo $row['id_matiere'];?>">
                        </div>

                         
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user"  name="coef" id="coef" placeholder="Coef"   value="<?php echo $row['coef'];?>">
                            </div>
                        </div>
...
if(isset($_POST['update']))
{
    ...
    $sql="UPDATE matiere set coef='$coef' WHERE id_matiere='$id_matiere'";   
	...
	if($res)
    {
       ?>
       <script>
		    swal("Matiere!", "a été modifier!", "success")
</script>
<?php
    }
?>
