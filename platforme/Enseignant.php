...
?>
        ...
        <nav class="navbar navbar-default">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <!--row begins-->
                    <!--row begins-->
                    <form action="Enseignant.php"   method="GET" class="search-form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" name="search" id="search" placeholder="recherche Enseignant par  CIN" style="font-size: 15px;">
                        </div>
                    </form>
            ...
            <?php
                        ...
                        {
                            require_once 'rechercheEnseignant.php';
                        }
 ...
 <?php
  ...
  require_once 'supprimerEnseignant.php';
        ...
        foreach ($r = $result->fetchAll() as $row) { ?> 
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="supprimerEnseignant.php?delete=<?php echo $row['cin']; ?>" class="btn-del"><input type="button"   id="ll_btn2" style="background-color:red" value="Supprimer"></td>
                                                        <td><a href="FormulaireModifierEnseignant.php?edite=<?php echo $row['cin']; ?>"><input type="button" id="ll_btn2" value="Editer"></td>
                                                        <td><a href="detailsEnseignant.php?detaile=<?= $row['cin']; ?>"><input type="button" id="ll_btn3" value="Details"></td>
