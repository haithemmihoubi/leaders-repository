...
if(isset($_POST['save']))
   {
    //session_start();
       ...
       $verife=$cnx->query("SELECT  nom_matiere FROM matiere WHERE nom_matiere='$nom_matiere'");
...
{
    $sql="INSERT INTO matiere (nom_matiere,coef) VALUES ('$nom_matiere', '$coef')";
    $res=$cnx->exec($sql);
     ...
     if($res)
     {
        ?>
        <script>
             swal("Matiere!", "a été ajouter!", "success")
 </script>
<?php
                ...
                <div class="p-5">
                    ...
                    <form class="user"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="nom_matiere" id="nom_matiere" placeholder="Matiere" required>
                        </div>

                        <div class="form-group">
                            <input type="number" class="form-control form-control-user" name="coef" id="coef" placeholder="coef" required>
                        </div>
