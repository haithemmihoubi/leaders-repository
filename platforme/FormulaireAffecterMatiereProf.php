            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <div class="text-center">
                        ...
                        Matiére dédié au profs !
                        </h1>
                    </div>
                    
<?php
  require_once 'ajouterMatiereProf.php';

?>

                    <form class="user"  method="post" enctype="multipart/form-data">
                    <label for="Matière" style="margin-left:12px">Matière</label>
...
foreach ($r = $result2->fetchAll() as $row2) { ?>
                ...
                <?php } ?>
                    ...
                    <div class="col-sm-6 mb-3 ">
                                <input type="text"   class="form-control form-control-user" id="cin_prof" name="cin_prof"  placeholder="Cin Prof" required>
                            </div>
