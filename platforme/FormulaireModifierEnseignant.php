...
require_once 'connexion.php';
$ref=$_GET['edite'];
$sql="SELECT * FROM enseignant WHERE cin='$ref'";
if($ref)
{
                    ...
                    <form class="user" action="#" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              ...
                              <input type="file" name="imageEnseignant"  title = "Choose a image please" value="<?php echo $row['imageEnseignant'];?>">Upload Image
...
if(isset($_POST['update']))
{
    ...
    $sql="UPDATE enseignant set  nom='$nom',prenom='$prenom',imageEnseignant='$imageEnseignant' WHERE cin='$cin'";   
	$res=$cnx->exec($sql);
	...
	if($res)
    {
       ?>
       <script>
		    swal("Enseignant!", "a été modifier!", "success")
</script>
<?php
    }
?>
