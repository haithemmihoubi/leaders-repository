        ...
        <nav class="navbar navbar-default">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <!--row begins-->
                    <!--row begins-->
                    <form action="Etudiant.php"   method="GET" class="search-form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" name="search" id="search" placeholder="recherche étudiant par  CIN" style="font-size: 15px;">
                        </div>
                    </form>
            ...
            <?php
                        ...
                        {
                            require_once 'rechercheEtudiant.php';
                        }
        ...
        foreach ($r = $result->fetchAll() as $row) { ?> 
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="supprimerEtudiant.php?delete=<?php echo $row['cin']; ?>&val=<?= $row['cin']; ?>" class="btn-del"><input type="button" id="ll_btn3"  value="Supprimer" style="background-color:red"></td>
