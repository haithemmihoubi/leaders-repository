                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="admin/pageHome.php" class="btn btn-danger navbar-btn btn-sm hidden-xs"><i class="fa fa-cog"></i>
                                            <strong>Admin Area</strong></a>
                                    ...
                                    <li class="divider"></li>
                                    <li><a class="btn navbar-btn btn-warning" href="index.php?signOut=1"><i class="fa fa-power-off"></i> <strong style="color:black">Sign
                                                Out</strong> </a></li>
                                </ul>
                            </li>
                        </ul>
                                    ...
                                    <div class="card-body">
                                        <div class="table table-bordered" style="color: #858796;">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <?php
require_once 'connexion.php';
$id_cour=$_GET['detaile'];
    $result = $cnx->query("SELECT * FROM cour where nom_matiere='$id_cour'");
