...
<?php
	require_once 'ajouterEtudiant.php';
   ?>
                ...
                <div class="p-5">
                    ...
                    <form class="user"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="date" class="form-control form-control-user" id="datePickerId"   name="date_naiss" id="date_naiss" placeholder="date naissance" required>
...
foreach ($r = $result2->fetchAll() as $row2) { ?>
                ...
                <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="number" class="form-control form-control-user" id="cin" id="cin" name="cin" placeholder="cin" required  pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==8) return false;">
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              ...
                              <input type="file" name="imageEtudiant"   title = "Choose a image please">Upload Image
