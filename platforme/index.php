            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="../index.php">leaders-university</a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="alert alert-success fade in">
                        ...
                        <strong><span class="ti ti-announcement fa-2x"></span> </strong> <strong>&nbsp;&nbsp; Bienvenue dans votre tableau de bord d'administration !!</strong>.
                    </div>
                    <?php
    require_once 'connexion.php';
                                ...
                                <div class="content">
                                    <div class="row">
                                        <div class="col-xs-5">
                                            ...
                                            <img src="https://img.icons8.com/color/48/000000/teacher.png"/>                                            </div>
                                        </div>
                                        <div class="col-xs-7">
                                            <div class="numbers">
                                ...
                                <div class="content">
                                    <div class="row">
                                        <div class="col-xs-5">
                                            ...
                                            <img src="https://img.icons8.com/dusk/48/000000/class.png"/>                                            </div>
                                        </div>
                                        <div class="col-xs-7">
                                            <div class="numbers">
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-xs-5">
                                            <div class="icon-big icon-success text-center">
                                            <img src="https://img.icons8.com/ultraviolet/40/000000/elective.png"/>                                            </div>
                                        </div>
                                        <div class="col-xs-7">
                                            <div class="numbers">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-xs-5">
                                        ...
                                        <img src="https://img.icons8.com/nolan/48/note.png"/>                                        </div>
                                    </div>
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                ...
                                <a href="FormulaireAjouterNote.php">
                                    <div class="footer">
                                        <hr />
                                        <div class="stats">
                                            <i class="ti-arrow-right"></i>View
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    <div class="col-xs-5">
                                        <div class="icon-big icon-primary text-center">
                                        <img src="https://img.icons8.com/fluent/48/000000/course-assign.png"/>                                        </div>
                                    </div>
                                    <div class="col-xs-7">
                                        <div class="numbers">
