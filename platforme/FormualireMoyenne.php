...
<div class="card o-hidden border-0 shadow-lg my-5">
    <div class="card-body p-0">
        ...
        <div style="display: flex;">
            <div class="col-lg-5 d-none d-lg-block" style="height:500px;  background-repeat:no-repeat; background-image:url('images/imageClasse/classe.jpg')" >
            </div>
                ...
                <div class="p-5">
                    ...
                    <div class="form-group row">
                          ...
                          <div class="col-sm-6 mb-3 mb-sm-0">
                              <input type="number" class="form-control form-control-user"  id="cin" name="cin" placeholder="cin" required  pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==8) return false;">
                          </div>
                          

                    </div>
                    <button  type="submit" class="btn btn-primary btn-user btn-block" name="submit">submit                        
</button>
                    </form>
