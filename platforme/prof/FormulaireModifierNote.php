...
if(isset($_POST['update']))
{
    ...
    $sql="UPDATE note set  nom_matiere='$nom_matiere',note_dc='$note_dc',note_ds='$note_ds',moyenne='$moyenne',note_np='$note_np',id_matiere='$id_matiere' WHERE cin_etudiant='$cin_etudiant' and nom_matiere='$nom_matiere' ";   
	$res=$cnx->exec($sql);
