...
<?php
  require_once 'ajouterSeanceCour.php';
...
foreach ($r = $result2->fetchAll() as $row2) { ?>
                ...
                <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" id="duree" name="duree"  placeholder="durée" required>
                            </div>

                    <div class="form-group">
                            <input type="date" class="form-control form-control-user" id="datePickerId"   name="dateDebut" id="dateDebut" placeholder="date" required>
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                              ...
                              <input type="file" name="lienCour"   title = "Choose a cour please">Upload Cour
