...
<head>
    ...
    <link href="../assets/css/DetailsClasse.css" rel="stylesheet">
                        ...
                        <div class="container-fluid">
                            <div>
                                ...
                                <h1 class="h3 mb-2 text-gray-800">
                                    Liste des étudiants  de classe <?php echo $nom_classe=$_GET['detaile'];?></h1>
...
$nom_classe=$_GET['detaile'];
    $result = $cnx->query("SELECT * FROM etudiant where nom_classe='$nom_classe'");
