                ...
                <div class="p-5">
                    ...
                    <form class="user"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="number" class="form-control form-control-user" id="cin_etudiant" name="cin_etudiant"  placeholder="CIN etudiant" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==8) return false;" required>
                            </div>
                    ...
                    <?php } ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="number" class="form-control form-control-user"  name="note_np" id="note_np" placeholder="Note NP " >
