...
foreach ($r = $result->fetchAll() as $row) { 
    ...
    $result2 = $cnx->query("SELECT * FROM etudiant where nom_classe='$val'");
    $pdoQuery = "SELECT * FROM etudiant where nom_classe='$val'";
        ...
        <div class="produit">
            <div>
                ...
                <div>
                    ...
                    <p class="h3_3" style="font-weight: bold;      font-family: 'Source Sans Pro',sans-serif">nombre d'etudiant : <?php echo  $pdoRowCount; ?>    </p>
